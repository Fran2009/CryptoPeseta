...
#ifndef CRYPTOPESETA_RPC_PROTOCOL_H
#define CRYPTOPESETA_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in cryptopesetad
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< CryptoPeseta is not connected
...
#endif // CRYPTOPESETA_RPC_PROTOCOL_H
