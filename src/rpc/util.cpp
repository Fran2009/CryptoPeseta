...
const std::string EXAMPLE_ADDRESS[2] = {"cpts1q2ymf6da2knl3c24g5lkkkckxpkrtdljzxpu5d9", "cpts02ad21edsxd23d32dfgqqsz4vv4nmtfzuklhy3"};
...
{
    return "> cryptopeseta-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleCliNamed(const std::string& methodname, const RPCArgList& args)
{
    std::string result = "> cryptopeseta-cli -named " + methodname;
