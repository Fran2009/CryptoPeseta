...
#ifndef CRYPTOPESETA_IPC_PROCESS_H
#define CRYPTOPESETA_IPC_PROCESS_H
...
//! IPC process interface for spawning cryptopeseta processes and serving requests
...
#endif // CRYPTOPESETA_IPC_PROCESS_H
