...
#ifndef CRYPTOPESETA_COMPAT_ASSUMPTIONS_H
#define CRYPTOPESETA_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "CryptoPeseta cannot be compiled without assertions."
#endif
...
#endif // CRYPTOPESETA_COMPAT_ASSUMPTIONS_H
