...
#ifndef CRYPTOPESETA_SCRIPT_SCRIPT_H
#define CRYPTOPESETA_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, CryptoPeseta always counted CHECKMULTISIGs
...
#endif // CRYPTOPESETA_SCRIPT_SCRIPT_H
