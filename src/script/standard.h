...
#ifndef CRYPTOPESETA_SCRIPT_STANDARD_H
#define CRYPTOPESETA_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a cryptopeseta address
 */
...
/**
 * Generate a CryptoPeseta scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // CRYPTOPESETA_SCRIPT_STANDARD_H
