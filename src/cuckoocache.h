...
#ifndef CRYPTOPESETA_CUCKOOCACHE_H
#define CRYPTOPESETA_CUCKOOCACHE_H
...
private:
     ...
     *  mod/division is fairly slow on ordinary cryptopesetaprocessors (e.g. 90-ish cycles on
...
#endif // CRYPTOPESETA_CUCKOOCACHE_H
