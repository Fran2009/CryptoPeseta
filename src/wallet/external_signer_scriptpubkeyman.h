...
#ifndef CRYPTOPESETA_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define CRYPTOPESETA_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // CRYPTOPESETA_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
