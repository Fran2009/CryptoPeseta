...
#ifndef CRYPTOPESETA_WALLET_WALLETUTIL_H
#define CRYPTOPESETA_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! cryptopeseta from opening the wallet, thinking it was newly created, and
...
#endif // CRYPTOPESETA_WALLET_WALLETUTIL_H
