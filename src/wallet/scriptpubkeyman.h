...
#ifndef CRYPTOPESETA_WALLET_SCRIPTPUBKEYMAN_H
#define CRYPTOPESETA_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The CryptoPeseta wallet was originally a collection of unrelated private
...
#endif // CRYPTOPESETA_WALLET_SCRIPTPUBKEYMAN_H
