...
#ifndef CRYPTOPESETA_WALLET_ISMINE_H
#define CRYPTOPESETA_WALLET_ISMINE_H
 ...
 * https://github.com/CryptoPesetaCPts/CryptoPeseta/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // CRYPTOPESETA_WALLET_ISMINE_H
