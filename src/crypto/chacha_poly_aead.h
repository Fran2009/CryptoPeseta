...
#ifndef CRYPTOPESETA_CRYPTO_CHACHA_POLY_AEAD_H
#define CRYPTOPESETA_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@cryptopeseta.
 *
 ...
 *
 * The chacha20-poly1305@cryptopeseta combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@cryptopeseta cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@cryptopeseta are relatively fast in
...
#endif // CRYPTOPESETA_CRYPTO_CHACHA_POLY_AEAD_H
