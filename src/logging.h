...
#ifndef CRYPTOPESETA_LOGGING_H
#define CRYPTOPESETA_LOGGING_H
...
static const bool DEFAULT_LOGTIMECRYPTOPESETAS = false;
...
namespace BCLog {
    ...
    public:
        ...
        bool m_log_time_cryptopesetas = DEFAULT_LOGTIMECRYPTOPESETAS;
