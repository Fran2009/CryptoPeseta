...
#ifndef CRYPTOPESETA_NET_H
#define CRYPTOPESETA_NET_H
 ...
 * src/qt/guiutil.cpp and src/cryptopeseta-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on CryptoPeseta’s Peer-to-Peer Network")
