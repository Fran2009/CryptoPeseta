...
#ifndef CRYPTOPESETA_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define CRYPTOPESETA_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // CRYPTOPESETA_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
