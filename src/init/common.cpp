...
void AddLoggingArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-logtimecryptopesetas", strprintf("Add microsecond precision to debug timestamps (default: %u)", DEFAULT_LOGTIMECRYPTOPESETAS), ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
...
void SetLoggingOptions(const ArgsManager& args)
{
    ...
    LogInstance().m_log_time_cryptopesetas = args.GetBoolArg("-logtimecryptopesetas", DEFAULT_LOGTIMECRYPTOPESETAS);
#ifdef HAVE_THREAD_LOCAL
...
bool StartLogging(const ArgsManager& args)
{
    ...
    fs::path config_file_path = GetConfigFile(args.GetArg("-conf", CRYPTOPESETA_CONF_FILENAME));
