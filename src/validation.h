...
#ifndef CRYPTOPESETA_VALIDATION_H
#define CRYPTOPESETA_VALIDATION_H
...
// LTC is 4x faster than CPTS (6 * 4)
// CPTS is 10x faster than CPTS (6 * 10)
...
#endif // CRYPTOPESETA_VALIDATION_H
