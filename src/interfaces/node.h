...
#ifndef CRYPTOPESETA_INTERFACES_NODE_H
#define CRYPTOPESETA_INTERFACES_NODE_H
...
//! Top-level interface for a cryptopeseta node (cryptopesetad process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // CRYPTOPESETA_INTERFACES_NODE_H
