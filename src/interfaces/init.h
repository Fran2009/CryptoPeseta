...
#ifndef CRYPTOPESETA_INTERFACES_INIT_H
#define CRYPTOPESETA_INTERFACES_INIT_H
...
//! (cryptopeseta-gui, cryptopeseta-node, cryptopeseta-wallet, cryptopesetad, cryptopeseta-qt) and each
...
#endif // CRYPTOPESETA_INTERFACES_INIT_H
