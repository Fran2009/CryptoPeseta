...
{
    static const yespower_params_t yespower_cryptopesetacryptopeseta = {
        .N = 2048,
        .r = 32,
    ...
    if (yespower_tls((unsigned char *)&ss[0], ss.size(), &yespower_cryptopesetacryptopeseta, (yespower_binary_t *)&thash)) {
