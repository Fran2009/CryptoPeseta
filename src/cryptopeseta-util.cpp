...
static void SetupCryptoPesetaUtilArgs(ArgsManager &argsman)
{
...
{
    SetupCryptoPesetaUtilArgs(args);
    std::string error;
    ...
    if (HelpRequested(args) || args.IsArgSet("-version")) {
        ...
        std::string strUsage = PACKAGE_NAME " cryptopeseta-util utility version " + FormatFullVersion() + "\n";
        if (!args.IsArgSet("-version")) {
            strUsage += "\n"
                "Usage:  cryptopeseta-util [options] [commands]  Do stuff\n";
            strUsage += "\n" + args.GetHelpMessage();
        }
