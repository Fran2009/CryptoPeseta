    ...
    mapper(nullptr)
{
    ...
    ui->cryptopesetaAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->cryptopesetaAtStartup);
    ...
    ui->cryptopesetaAtStartup->setToolTip(ui->cryptopesetaAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->cryptopesetaAtStartup->setText(ui->cryptopesetaAtStartup->text().arg(PACKAGE_NAME));

    ui->openCryptoPesetaConfButton->setToolTip(ui->openCryptoPesetaConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new CryptoPesetaUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->cryptopesetaAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openCryptoPesetaConfButton_clicked()
{
    ...
    if (!GUIUtil::openCryptoPesetaConf())
