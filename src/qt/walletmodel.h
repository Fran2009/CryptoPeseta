...
#ifndef CRYPTOPESETA_QT_WALLETMODEL_H
#define CRYPTOPESETA_QT_WALLETMODEL_H
...
/** Interface to CryptoPeseta wallet from Qt view code. */
...
#endif // CRYPTOPESETA_QT_WALLETMODEL_H
