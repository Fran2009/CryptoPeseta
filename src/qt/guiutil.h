...
#ifndef CRYPTOPESETA_QT_GUIUTIL_H
#define CRYPTOPESETA_QT_GUIUTIL_H
...
/** Utility functions used by the CryptoPeseta Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "cryptopeseta:" URI into recipient object, return true on successful parsing
...
#endif // CRYPTOPESETA_QT_GUIUTIL_H
