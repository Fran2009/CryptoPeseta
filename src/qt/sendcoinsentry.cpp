    ...
    platformStyle(_platformStyle)
{
    ...
    // normal cryptopeseta address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying cryptopeseta address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &CryptoPesetaAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
