...
#ifndef CRYPTOPESETA_QT_SENDCOINSDIALOG_H
#define CRYPTOPESETA_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending cryptopesetas */
...
#endif // CRYPTOPESETA_QT_SENDCOINSDIALOG_H
