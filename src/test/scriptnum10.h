...
#ifndef CRYPTOPESETA_TEST_SCRIPTNUM10_H
#define CRYPTOPESETA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from CryptoPeseta 0.10.0, for cross-comparison.
 */
public:
...
#endif // CRYPTOPESETA_TEST_BIGNUM_H
