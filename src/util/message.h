...
#ifndef CRYPTOPESETA_UTIL_MESSAGE_H
#define CRYPTOPESETA_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's cryptopeseta address, it must refer to a public key.
...
#endif // CRYPTOPESETA_UTIL_MESSAGE_H
