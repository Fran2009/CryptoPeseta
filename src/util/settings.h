...
#ifndef CRYPTOPESETA_UTIL_SETTINGS_H
#define CRYPTOPESETA_UTIL_SETTINGS_H
...
//!       https://github.com/CryptoPesetaCPts/CryptoPeseta/pull/15934/files#r337691812)
...
#endif // CRYPTOPESETA_UTIL_SETTINGS_H
