...
using the Linux kernel, macOS 10.12+, and Windows 7 and newer.  CryptoPeseta
Core should also work on most other Unix-like systems but is not as
frequently tested on them.  It is not recommended to use CryptoPeseta Core on
unsupported systems.

From CryptoPeseta Core 0.20.0 onwards, macOS versions earlier than 10.12 are no
longer supported. Additionally, CryptoPeseta Core does not yet change appearance
...
fungibility of all cryptopesetas. Spenders will enjoy lower fees and the
...
The addition of taproot-related features to CryptoPeseta Core's wallet is
...
- Technical specifications
  - [BIP340 Schnorr signatures for secp256k1](https://github.com/cryptopeseta/bips/blob/master/bip-0340.mediawiki) 
  - [BIP341 Taproot: SegWit version 1 spending rules](https://github.com/cryptopeseta/bips/blob/master/bip-0341.mediawiki)
  - [BIP342 Validation of Taproot scripts](https://github.com/cryptopeseta/bips/blob/master/bip-0342.mediawiki)

- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit CryptoPeseta](https://cryptopesetamagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-cryptopeseta)
  - [What do Schnorr Signatures Mean for CryptoPeseta?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-cryptopeseta)
...
- Development history overview
  - [Taproot](https://cryptopesetaops.org/en/topics/taproot/)
  - [Schnorr signatures](https://cryptopesetaops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://cryptopesetaops.org/en/topics/tapscript/)
  - [Soft fork activation](https://cryptopesetaops.org/en/topics/soft-fork-activation/)

- Other
  - [Questions and answers related to taproot](https://cryptopeseta.stackexchange.com/questions/tagged/taproot)
...
- Due to [BIP 350](https://github.com/cryptopeseta/bips/blob/master/bip-0350.mediawiki)
  ...
  (e.g. through [BIP 341](https://github.com/cryptopeseta/bips/blob/master/bip-0341.mediawiki)).
...
### Documentation
- #21384 add signet to cryptopeseta.conf documentation (jonatack)
