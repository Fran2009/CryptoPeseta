...
class TestShell:
    """Wrapper Class for CryptoPesetaTestFramework.

    The TestShell class extends the CryptoPesetaTestFramework
    ...
    class __TestShell(CryptoPesetaTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by CryptoPesetaTestFramework child class.
            self.num_nodes = 1
