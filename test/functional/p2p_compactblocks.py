...
# TestP2PConn: A peer we use to send messages to cryptopesetad, and store responses.
...
class CompactBlocksTest(CryptoPesetaTestFramework):
    ...
    # This test actually causes cryptopesetad to (reasonably!) disconnect us, so do this last.
    ...
    # cryptopesetad's choice of nonce.
    ...
    # Test that cryptopesetad requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for cryptopesetad to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # cryptopesetad will not send blocktxn responses for blocks whose height is
