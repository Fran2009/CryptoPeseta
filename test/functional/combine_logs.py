#!/usr/bin/env python3
# Copyright (c) 2017-2019 The CryptoPeseta Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Combine logs from multiple cryptopeseta nodes as well as the test_framework log.
            ...
            for line in infile:
                ...
                if time_match:
                    ...
                    if time_match.group(1) is None:
                        ...
                        timestamp_cryptopeseta = timestamp.replace("Z", ".000000Z")
                        line = line.replace(timestamp, timestamp_cryptopeseta)
                        timestamp = timestamp_cryptopeseta
                    event = line
