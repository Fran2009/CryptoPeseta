...
"""Verify that starting cryptopeseta with -h works as expected."""

from test_framework.test_framework import CryptoPesetaTestFramework
from test_framework.util import assert_equal

class HelpTest(CryptoPesetaTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cryptopeseta with -h for help text")
        ...
        self.log.info("Start cryptopeseta with -version for version information")
        ...
        self.log.info("Start cryptopesetad with -fakearg to make sure it does not start")
