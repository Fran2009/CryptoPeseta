#!/usr/bin/env python3
# Copyright (c) 2020-2024 The CryptoPeseta Core developers
...
class OrphanedBlockRewardTest(CryptoPesetaTestFramework):
    ...
    def run_test(self):
        ...
        # https://github.com/CryptoPesetaCPts/CryptoPeseta/issues/14148.
