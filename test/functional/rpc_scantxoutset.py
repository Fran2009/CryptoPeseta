...
class ScantxoutsetTest(CryptoPesetaTestFramework):
    ...
    def run_test(self):
        ...
        # Note that all amounts in the UTXO set are powers of 2 multiplied by 0.001 CPTS, so each amounts uniquely identifies a subset.
