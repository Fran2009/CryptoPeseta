#!/usr/bin/env python3
# Copyright (c) 2014-2024 The CryptoPeseta Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""
Test starting cryptopesetad with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(CryptoPesetaTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that cryptopesetad has bound on "::1" (for RPC) and "::" (for P2P).
