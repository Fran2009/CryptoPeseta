...
class WalletLabelsTest(CryptoPesetaTestFramework):
    ...
    def run_test(self):
        ...
        # each with 1 address with a balance of 50 CryptoPesetas
        ...
        if self.options.descriptors:
            ...
            for l in BECH32_INVALID:
                ...
                assert_raises_rpc_error(
                    -5,
                    "Address is not valid" if self.options.descriptors else "Invalid CryptoPeseta address or script",
