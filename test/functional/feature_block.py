#!/usr/bin/env python3
# Copyright (c) 2015-2020 The CryptoPeseta Core developers
...
class FullBlockTest(CryptoPesetaTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure cryptopesetad isn't accepting b26
        ...
        # Extend the b28 chain to make sure cryptopesetad isn't accepting b28
        ...
        # cryptopesetad doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the cryptopeseta code has custom code which does so);
