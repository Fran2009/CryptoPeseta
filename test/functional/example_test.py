...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the CryptoPesetaTestFramework
    pass


class ExampleTest(CryptoPesetaTestFramework):
    # Each functional test is a subclass of the CryptoPesetaTestFramework class.
    ...
    def custom_method(self):
        ...
        CryptoPesetaTestFramework class so other tests can use it."""
