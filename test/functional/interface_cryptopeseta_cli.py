...
# The block reward of coinbaseoutput.nValue (50) CPTS/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 CPTS/block.
...
class TestCryptoPesetaCli(CryptoPesetaTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `cryptopeseta-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and cryptopeseta-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 CPTS) to the default wallet.
            ...
            # Test cryptopeseta-cli -generate.
            n1 = 3
            n2 = 4
            ...
            # Test cryptopeseta-cli -generate with -rpcwallet in multiwallet mode.
