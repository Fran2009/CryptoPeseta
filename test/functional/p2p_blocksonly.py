#!/usr/bin/env python3
# Copyright (c) 2019-2020 The CryptoPeseta Core developers
...
class P2PBlocksOnly(CryptoPesetaTestFramework):
    ...
    def blocksonly_mode_tests(self):
        ...
        with self.nodes[0].assert_debug_log(["received getdata"]):
            ...
            # and CryptoPeseta Core respects that choice and will not send transactions.
            # But if, for some reason, first_peer decides to relay transactions to us anyway, we should relay them to
            # second_peer since we gave relay permission to first_peer.
            # See https://github.com/CryptoPesetaCPts/CryptoPeseta/issues/19943 for details.
