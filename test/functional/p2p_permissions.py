...
class P2PPermissionsTests(CryptoPesetaTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].cryptopesetaconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].cryptopesetaconf, 'w', encoding="utf8") as f:
            f.write(newText)
