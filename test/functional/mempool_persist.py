...
By default, cryptopesetad will dump mempool on shutdown and
...
class MempoolPersistTest(CryptoPesetaTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent cryptopesetad from writing mempool.dat to disk. Verify that `savemempool` fails")
