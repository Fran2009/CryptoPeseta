...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the cryptopeseta repository."
  exit 1
fi
...
# See https://github.com/CryptoPesetaCPts/CryptoPeseta/issues/16064
...
echo 'When compiling cryptopesetad, run `./configure` in the following way:'
echo
