...
(define* (make-cryptopeseta-cross-toolchain target
                                       #:key
...
desirable for building CryptoPeseta Core release binaries."
...
(define glibc-2.27/cryptopeseta-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-cryptopeseta-cross-toolchain target
                                                      #:base-libc glibc-2.27/cryptopeseta-patched
