...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef CRYPTOPESETA_CHAINPARAMSSEEDS_H\n')
    g.write('#define CRYPTOPESETA_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the cryptopeseta network\n')
    ...
    g.write('#endif // CRYPTOPESETA_CHAINPARAMSSEEDS_H\n')
